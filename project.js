...
const getBet = (balance, numberOfLines) => {
    while (true){
        ...
        if (isNaN(numberBet) || (numberBet * numberOfLines) > balance || numberBet <= 0) {
            console.log('Invalid bet! Please enter an ammount you actually have. Make sure the bet times the lines bet on does not exceed your balance.');
        } else {
            return numberBet;
        }
    }
